export const profile = {
  ...
  metrics: [
    { label: "Career", value: "2022.02 -" },
    { label: "Projects", value: "8+" },
    { label: "Core", value: "Java / Spring" },
  ],
  about: [
    "레드소프트 솔루션개발본부에서 웹 개발자로 근무하며 금융, 호텔, 제조, 식품, CRM 영역의 엔터프라이즈 시스템을 개발했습니다. 사용자의 업무 프로세스를 이해하고 접수, 배분, 처리, 결재, 분석으로 이어지는 흐름을 안정적으로 구현하는 데 강점이 있습니다.",
